...
import img1 from '../../assests/Flims/tpm-theatres-spheres-hero-desktop_d3aefa27.jpeg'
import img2 from "../../assests/Flims/phantom-menace-ferguson-onesheet-final-empirestrap_arti_e95a79c8.jpeg"
    ...
    <div className='banner-img-all'>
      ...
      <div className="banner-img-2-text">
        ...
        <div className='movie_btn '>
               <button className='color-white '> <Link>READ MORE</Link></button>
               <button className='color-white'> <Link>INTERVIEW</Link></button>
       </div>
      </div>
