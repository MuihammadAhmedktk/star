...
const Home = () => {
  ...
  const lastNewsDetail = useSelector((state: RootState) => state.lastNew.data);
  const lastNewsStatus = useSelector((state: RootState) => state.lastNew.status);
  const error = useSelector((state: RootState) => state.lastNew.error);
  useEffect(() => {
